...
class PreActResNet_gate(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        super(PreActResNet_gate, self).__init__()
        self.in_planes = 64
...
def PreActResNet18(gate, num_classes=10):
    if not gate:
        return PreActResNet(PreActBlock, [2,2,2,2], num_classes)
    else:
        return PreActResNet_gate(PreActBlock, [2,2,2,2], num_classes)

def PreActResNet34():
    return PreActResNet(PreActBlock, [3,4,6,3])

def PreActResNet50(gate, num_classes=10):
    if not gate:
